...
class Request
{
    ...
    public function __construct()
    {
         ...
         * 可用于 Coentent-Type 取值为 application/x-www-data-urlencoded、text/json、text/xml，不能用于 multipart/form-data 类型。
         *
         * 用 $_POST 的话，仅在Coentent-Type取值为 application/x-www-data-urlencoded 和 multipart/form-data 两种情况下有用
         */
    ...
    public static function __make(App $app)
    {
        ...
        // apache_request_headers 的作用是获取所有HTTP请求头
