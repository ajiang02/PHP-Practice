...
class Route
{
    ...
    public function dispatch(Request $request, $withRoute = null)
    {
        ...
        if ($withRoute) {
            ...
            // 如果关闭路由解析
            // $this->path()得到PATHINFO，比如 控制器/方法：/demo/hello
            // $dispatch 是 think\route\dispatch\Url 的实例，该类继承了Controller类
            $dispatch = $this->url($this->path());
        }

        // 该类中没有 init()， 所以这里执行的是其父类 think\route\dispatch\Controller 的 init()
    ...
    {
        // UrlDispatch = think\route\dispatch\Url
